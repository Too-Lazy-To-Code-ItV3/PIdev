...
@FXML
    ...
    for (Post post : posts) {
        ...
        likesLabel.setStyle("-fx-text-fill: white;");
            ...
            addCommentButton.setPrefHeight(55.0);
            addCommentButton.setPrefWidth(186.0);
        ...
        button1.setOnAction(event -> {
            ...
            deletePostButton.setTextFill(Color.WHITE);
               ...
               p.setTitle(post.getTitle());
                 String title = post.getTitle();
                 int CreaterUserIdd = postService.getIdUserByTitle(title);   
                deletePostButton.setVisible(CreaterUserIdd == Logged.get_instance().getUser().getID_User());
                deletePostButton.setOnAction(event -> {        
                    //Post p = new Post();
                    p.setTitle(post.getTitle());
                    int CreaterUserId = postService.getIdUserByTitle(p.getTitle());
            ...
            ModifyPostButton.setVisible(CreaterUserIdd == Logged.get_instance().getUser().getID_User());
            ...
            Donate.setLayoutX(1039.0);
            Donate.setLayoutY(612.0);
            Donate.setPrefHeight(46.0);
            Donate.setPrefWidth(202.0);
            Donate.setStyle("-fx-background-color: C10C99;");
            Donate.setTextFill(Color.WHITE);
                ...
                try {
                    Parent root = FXMLLoader.load(getClass().getResource("Amount.fxml"));
                    Scene scene = new Scene(root);
                    stage.setScene(scene);
                    stage.show();
            ...
            buttonBox.getChildren().addAll(addCommentButton, button1, button2, button3 , Donate, deletePostButton, ModifyPostButton); 

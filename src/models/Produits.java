...
public class Produits {
    ...
    public Produits(int idProduit,int ID_User,AllUsers User, Category categorieProduit,String nom, String description, String image , double prix, Date dateAjout) {

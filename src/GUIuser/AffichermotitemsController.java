...
public class AffichermotitemsController implements Initializable {
    ...
    public void loaddata(AllUsers g) throws SQLException {
        titreOffre.setText(g.getNickname());
        supprimer.setId(Integer.toString(g.getID_User()));
        modifier.setId(Integer.toString(g.getID_User()));
    }
    ...
    private void modifier(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/GUIuser/modifiermot.fxml"));

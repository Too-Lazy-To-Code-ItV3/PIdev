...
public class FXML_Modify_TutorielController implements Initializable {
    ...
    private void importImage(ActionEvent event) {
           ...
           if(selectedFile != null) {
               ...
               tutoriel.setPathImg(selectedFile.getPath());
               Image imageg = new Image(getClass().getResourceAsStream(selectedFile.getPath()));
    ...
    void getTutoriel(Tutoriel t) {
        ...
        comboBox.setValue(t.getCategorie().getNameCategorie());
    ...
    private void modifyTutoriel(ActionEvent event) throws IOException {
        ...
        tutoriel.setCategorie(ci.fetchCategorieByName(comboBox.getValue().toString()));
